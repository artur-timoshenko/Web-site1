...
urlpatterns = [
    ...
    re_path(r'^cart/$', login_required(views.CartPageView.as_view(), login_url='/store4/sign-in/'), name='CartPageView'),
    ...
    re_path(r'^stripe/portal/$', login_required(views.StripeCreatePortalSession, login_url='/store4/sign-in/'), name='StripeCreatePortalSession'),
