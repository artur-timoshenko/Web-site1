...
class HomePageView(TemplateView):
    def get(self, request, *args, **kwargs):
        ...
        response = render(request=request, template_name='store3/index.html', context=context)
...
class PricingPageView(TemplateView):
    def get(self, request, *args, **kwargs):
        ...
        context['publishableKey'] = 'pk_test_51PtQsORtNyq2hGfaNCfHVhn5n0goHzXxm6AMyfDWn7zqW1TFfPBumCAqmyB3socflMXBGa8ZLw2JbZHKUnE3yceY00OkPgOA9G'

        response = render(request=request, template_name='store3/pricing/index.html', context=context)
...
class ProductsPageView(TemplateView):
    def get(self, request, *args, **kwargs):
        ...
        response = render(request=request, template_name='store3/products/index.html', context=context)
...
class CartPageView(TemplateView):
    def get(self, request, *args, **kwargs):
        ...
        response = render(request=request, template_name='store3/cart/index.html', context=context)
...
class SignInPageView(TemplateView):
    def get(self, request, *args, **kwargs):
        ...
        response = render(request=request, template_name='store3/sign/sign-in.html', context=context)
    ...
    def post(self, request, *args, **kwargs):
        ...
        return redirect('/store3/sign-in/')
...
class SignUpPageView(TemplateView):
    def get(self, request, *args, **kwargs):
        ...
        response = render(request=request, template_name='store3/sign/sign-up.html', context=context)
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return redirect('/store3/sign-up/')
...
class StripeCompleteView(TemplateView):
    def get(self, request, *args, **kwargs):
        ...
        response = render(request=request, template_name='store3/stripe/complete.html', context=context)
    ...
    if request.method == 'POST':
        try:
            ...
            checkout_session = stripe.checkout.Session.create(
                ...
                mode='payment',
                locale='en',
                success_url='http://localhost:8000/store3' +
                            '/stripe/complete?session_id={CHECKOUT_SESSION_ID}',
                cancel_url='http://localhost:8000/store3/' #+ '/cancel.html',
                # return_url='http://localhost:8000/store3' + '/',
...
def StripeCreatePortalSession(request):
    ...
    if not customer:
        return redirect('/store3/sgin-in/')

    return_url = 'http://localhost:8000/store3/pricing/'
